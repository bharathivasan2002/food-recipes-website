...
const Seafoods = () => {
  ...
  const getpopularmeals = async ()=>{
    const api = await Axios.get(`https://www.themealdb.com/api/json/v1/1/filter.php?c=Seafood`)
  ...
  return (
    ...
    <Container>
    <div className='text-start text-muted my-4' style={{letterSpacing:'2px',fontSize:'20px',fontWeight:'500'}}>Sea Foods</div>
     <Slider {...settings}>
          {
